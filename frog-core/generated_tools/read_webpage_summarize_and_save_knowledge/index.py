...
def execute(params: dict, context: dict) -> dict:
    steps_str = r"""[{"tool_name": "web_browser", "params": {"url": "{url}", "save_to_knowledge": true, "max_chars": 12000}}, {"tool_name": "project_memory", "params": {"action": "save", "key": "{memory_key}", "value": "{summary_text}"}}]"""
